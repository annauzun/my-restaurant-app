        ...
        <div className="my-10 gap-3 grid sm:grid-cols-2 lg:grid-cols-3">
            {restaurants.map((restaurant) => {
                ...
                <div className="mx-10 flex flex-col my-2 border rounded-md ">
                    <img src={restaurant.image} className=" h-48 object-cover object-center" ></img>
                <h3 className="text-3xl text-sky-800 text-center">{restaurant.name}</h3>
                <p className=" text-sky-800">{restaurant.description}</p>
